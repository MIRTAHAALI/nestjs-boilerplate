...
let ItemsController = ItemsController_1 = class ItemsController {
    ...
    findAll() {
        this.logger.log('Calling findAll()', ItemsController_1.name);
    ...
    create(createItemDto) {
        this.logger.log('Calling create()', ItemsController_1.name);
...
ItemsController = ItemsController_1 = __decorate([
    (0, common_1.Controller)('items'),
    __param(1, (0, common_1.Inject)(nest_winston_1.WINSTON_MODULE_PROVIDER)),
    __metadata("design:paramtypes", [items_service_1.ItemsService, winston_1.Logger])
], ItemsController);
